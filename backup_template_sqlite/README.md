...
Асинхронный Telegram-бот на `aiogram 3` с использованием `SQLite`/`Google Sheets` и `APScheduler`.
...
4. **Настроить переменные окружения:**
   ...
   - `STORAGE_BACKEND=sqlite` (по умолчанию) или `STORAGE_BACKEND=sheets`.
